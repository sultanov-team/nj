...
(def defaults
  {:src-dirs       ["src/main/clojure"]
   ...
   :lib            'team.sultanov/ninja.versioniq
   :main           'ninja.versioniq
   :target         "target"
   :coverage-dir   "coverage"
   :dist-dir       "dist"
   :jar-file       "target/ninja.versioniq.jar"
   :uber-file      "target/ninja.versioniq.uber.jar"
   :build-meta-dir "src/main/resources/ninja/versioniq"})
